...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A foundation framework of CubeEngine.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
foundation framework of CubeEngine
                       DESC

  s.homepage         = 'https://github.com/Ashine/CubeEngineFoundationKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ashine' => '758988371@qq.com' }
  s.source           = { :git => 'https://github.com/Ashine/CubeEngineFoundationKit.git', :tag => s.version.to_s }
